<template>
    <div style="padding-left:20px;">
      ...
      <el-table v-loading="loading" :data="deviceLogList" >
...
const {
  ...
  function getList() {
    ...
    var ssf=proxy.addDateRange(queryParams, daterangeTime.value);

    listEventLog(proxy.addDateRange(queryParams, daterangeTime.value)).then(response => {
