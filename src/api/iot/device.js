...
export function updateIsApprove(data) {
  return request({
    url: '/iot/device/updateIsApprove',
    method: 'post',
    data: data,
  });
}
...
// 查询设备列表
export function listDeviceConnectionReview(query) {
  return request({
    url: '/iot/device/listDeviceConnectionReview',
    method: 'get',
    params: query,
  });
}
...
// 获取设备大屏首页列表
export function getDeviceBigScreenIndexList() {
  return request({
    url: '/iot/device/getDeviceBigScreenIndexList',
    method: 'get',
  });
}
